...
def generate_content(title, max_tokens=150, temperature=0.7):
    ...
    def get_intro_and_conclusion(title):
        ...
        conclusion_prompt = f"You are an Australian mortgage broker writing a blog post titled '{title}'. Your firm is called xxx. Write a conclusion for a blog post with the title: '{title}'. Emphasize how your firm would love to help and answer questions and encourage the reader to contact you"
